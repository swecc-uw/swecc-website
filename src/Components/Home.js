...
function HomePage() {
    ...
    function Carousel() {
        ...
        const nextImg = () => {
            setCurrentIndex((prevIndex) => (prevIndex === backGroundImgs.length - 1 ? 0 : prevIndex + 1));
        };

        const prevImg = () => {
            setCurrentIndex((prevIndex) => (prevIndex === 0 ? backGroundImgs.length - 1 : prevIndex - 1));
        };
        ...
        return (
            <div className="clubTitleSection">
                ...
                <div className="buttons-container">
                    <button onClick={prevImg} className="prevImgButton"><span
                        className="material-symbols-outlined">navigate_before</span></button>

                    <button onClick={nextImg} className="nextImgButton"><span
                        className="material-symbols-outlined">navigate_next</span></button>
                </div>
        ...
        <div>
            ...
            <div className="whatWeDoSection">
                ...
                <p className="summary">
                    ...
                    Washington in Seattle. Our mission is to support and empower individuals interested in pursuing a
                    successful career in software engineering. We offer a wide range of activities and resources,
                    including networking events, LeetCode challenges, mentorship programs, and interview preparation, to
                    help our members thrive in the field. Join SWECC to jumpstart your software engineering career with
