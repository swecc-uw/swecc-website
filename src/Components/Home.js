...
function HomePage() {
    ...
    function Carousel() {
        ...
        const divStyle = {
            backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), url(${backGroundImgs[currentIndex]})`,
        ...
        return (
            <div className="clubTitleSection" style={divStyle}>
                <div className="buttons-container">
                    <button onClick={prevImg} className="prevImgButton">&lt;</button>
                    <button onClick={nextImg} className="nextImgButton">&gt;</button>
                </div>
